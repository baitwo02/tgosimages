...
AXVISOR_TOOLS_REF="${AXVISOR_TOOLS_REF:-ivc}"
...
usage() {
    ...
    printf '  * qemu-aarch64 Alpine rootfs also receives Axvisor IVC debug payloads when available.\n'
...
arceos() {
    ...
    local config_path="${BUILD_DIR}/qemu-${ARCH}-arceos.toml"
